    ...
    <div className='add'>
      <form className='flex-col' onSubmit={onSubmitHandler}>
        ...
        <div className="add-product-name flex-col">
          <p>Tên sản phẩm</p>
          <input onChange={onChangeHandler} value={data.name} type="text" name='name' placeholder='Nhập ở đây' />
        </div>
        ...
        <div className="add-category-price">
          ...
          <div className="add-price flex-col">
            <p>Giá sản phẩm</p>
            <input onChange={onChangeHandler} value={data.price} type="Number" name='price' placeholder='VNĐ20' />
          </div>
        </div>
